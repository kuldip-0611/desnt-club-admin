...
const ProductCategoryForm = (): ReactElement => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ cid, payload }: { cid: string; payload: Record<string, unknown> }) =>
      ...
      <Formik
        ...
        onSubmit={(values) => {
          ...
          if (isCreate) {
            ...
            updateMutation.mutate({ cid: id, payload })
          }
        }}
      >
          ...
          <Form className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                Lower numbers appear first in dropdowns (e.g. Tracks before Tees).
              </p>
            </div>
